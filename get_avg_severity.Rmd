...
plot_bees_in_fire_region <- function(bee_data, fire_sp_obj) {
  ...
  ## Make sure fire spacial obj matches oregon map's CRS
  ...
  fire_buffer <- st_buffer(fire_bbox, dist = 50000)
  ...
  ggplot() +
    ...
    labs(
      title = "Bees in Fire Region with 50 km Buffer",
...
plot_bees_in_fire_region(bees_after_2020, umpqua_2020)

plot_bees_in_fire_region(bees_before_2020, hood_2020)
plot_bees_in_fire_region(bees_after_2020, hood_2020)

plot_bees_in_fire_region(bees_before_2020, holiday_2020)
plot_bees_in_fire_region(bees_after_2020, holiday_2020)
...
```{r average severity}
define_avg_severity <- function(fire_sp_raster) {
  ### This function takes all the severity data ("Layer_1" in the raster)
  ### returns the average severity for the fire
  
  values <- values(fire_sp_raster$Layer_1)
  valid_values <- values[!is.na(values)]
  avg_severity <- mean(valid_values, na.rm = TRUE)
  
  return(avg_severity)
}


define_avg_severity(umpqua_2020)
define_avg_severity(hood_2020)
define_avg_severity(holiday_2020)
```