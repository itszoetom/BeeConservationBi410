...
plot_bees_in_fire_region <- function(bee_data, fire_sp_obj, fire_name) {
  ...
  fire_buffer <- st_buffer(fire_bbox, dist = 5000)
...
umpqua_before_fire <- nrow(bees_before_fire(9))
hood_before_fire <- nrow(bees_before_fire(9))
holiday_before_fire <- nrow(bees_before_fire(9))
beachie_before_fire <- nrow(bees_before_fire(8))
freemont_before_fire <- nrow(bees_before_fire(8))
ben_young_before_fire <- nrow(bees_before_fire(7))
brattain_before_fire <- nrow(bees_before_fire(9))
lionshead_before_fire <- nrow(bees_before_fire(9))
thielsen_before_fire <- nrow(bees_before_fire(9))
two_four_before_fire <- nrow(bees_before_fire(9))
whiteriver_before_fire <- nrow(bees_before_fire(8))

# Extract number of rows for after fire data
umpqua_after_fire <- nrow(bees_after_fire(9))
hood_after_fire <- nrow(bees_after_fire(9))
holiday_after_fire <- nrow(bees_after_fire(9))
beachie_after_fire <- nrow(bees_after_fire(8))
freemont_after_fire <- nrow(bees_after_fire(8))
ben_young_after_fire <- nrow(bees_after_fire(7))
brattain_after_fire <- nrow(bees_after_fire(9))
lionshead_after_fire <- nrow(bees_after_fire(9))
thielsen_after_fire <- nrow(bees_after_fire(9))
two_four_after_fire <- nrow(bees_after_fire(9))
whiteriver_after_fire <- nrow(bees_after_fire(8))
```
