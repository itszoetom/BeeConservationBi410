...
umpqua_before_fire <- bees_in_buffer_zone(bees_before_2020, umpqua_2020)
hood_before_fire <- bees_in_buffer_zone(bees_before_2020, hood_2020)
holiday_before_fire <- bees_in_buffer_zone(bees_before_2020, holiday_2020)
beachie_before_fire <- bees_in_buffer_zone(bees_before_2020, beachie_2020)
freemont_before_fire <- bees_in_buffer_zone(bees_before_2020, freemont_2020)
ben_young_before_fire <- bees_in_buffer_zone(bees_before_2020, ben_young_2020)
brattain_before_fire <- bees_in_buffer_zone(bees_before_2020, brattain_2020)
lionshead_before_fire <- bees_in_buffer_zone(bees_before_2020, lionshead_2020)
thielsen_before_fire <- bees_in_buffer_zone(bees_before_2020, thielsen_2020)
two_four_before_fire <- bees_in_buffer_zone(bees_before_2020, two_four_2020)
whiteriver_before_fire <- bees_in_buffer_zone(bees_before_2020, whiteriver_2020)

# Extract number of rows for after fire data
umpqua_after_fire <- bees_in_buffer_zone(bees_after_2020, umpqua_2020)
hood_after_fire <- bees_in_buffer_zone(bees_after_2020, hood_2020)
holiday_after_fire <- bees_in_buffer_zone(bees_after_2020, holiday_2020)
beachie_after_fire <- bees_in_buffer_zone(bees_after_2020, beachie_2020)
freemont_after_fire <- bees_in_buffer_zone(bees_after_2020, freemont_2020)
ben_young_after_fire <- bees_in_buffer_zone(bees_after_2020, ben_young_2020)
brattain_after_fire <- bees_in_buffer_zone(bees_after_2020, brattain_2020)
lionshead_after_fire <- bees_in_buffer_zone(bees_after_2020, lionshead_2020)
thielsen_after_fire <- bees_in_buffer_zone(bees_after_2020, thielsen_2020)
two_four_after_fire <- bees_in_buffer_zone(bees_after_2020, two_four_2020)
whiteriver_after_fire <- bees_in_buffer_zone(bees_after_2020, whiteriver_2020)
```
...
```
```{r}
umpqua_before <- bees_in_buffer_zone(bees_before_2020, umpqua_2020)
umpqua_after <- bees_in_buffer_zone(bees_after_2020, umpqua_2020)

hood_before <- bees_in_buffer_zone(bees_before_2020, hood_2020)
hood_after <- bees_in_buffer_zone(bees_after_2020, hood_2020)

holiday_before <- bees_in_buffer_zone(bees_before_2020, holiday_2020)
holiday_after <- bees_in_buffer_zone(bees_after_2020, holiday_2020)

beachie_before <- bees_in_buffer_zone(bees_before_2020, beachie_2020)
beachie_after <- bees_in_buffer_zone(bees_after_2020, beachie_2020)
...
visual_data <- data.frame(
  Location = c(
    "Umpqua", "Hood", "Holiday", "Beachie", "Freemont", 
